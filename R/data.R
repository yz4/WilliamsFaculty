#' Ages of all Williams faculty 
#' 
#' A dataset containing the department, graduation year, and age of all 403 Williams
#' faculty, including visiting lecturers
#' 
#' @format A data frame with 403 rows and 4 variables:
#' \describe{
